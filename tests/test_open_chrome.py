...
#         page.fill('input[name="name"]', 'TestUser99')
#         page.fill('input[data-qa="signup-email"]', 'testser99@example.com')
#         page.click('button[data-qa="signup-button"]')
#         page.wait_for_selector('b:has-text("Enter Account Information")', timeout=30000)
#         page.check('input[id="id_gender1"]')  # Mr.
...
#         assert page.locator('a:has-text("Logged in as")').is_visible()
#         print("Step 14: User is logged in successfully")
#         page.click('a:has-text("Delete Account")')
#         page.wait_for_selector('b:has-text("Account Deleted!")', timeout=30000)
#         browser.close()
